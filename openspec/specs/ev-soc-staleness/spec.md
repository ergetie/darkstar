# ev-soc-staleness Specification

## Purpose
Bound how long a last valid EV SoC reading is trusted, suspend goal charging with a warning when it goes stale, and replan once on recovery.
## Requirements
