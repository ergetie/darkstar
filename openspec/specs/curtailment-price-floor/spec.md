...
The Kepler solver SHALL never pay the grid to accept surplus PV. When the effective export price for a slot is at or below zero, curtailing the surplus SHALL be preferred over exporting it; when the effective export price is positive, revenue-positive export SHALL be preferred over waste.
