...
## Purpose
This specification defines the fault-injection test suite that exercises Darkstar's degraded-mode behavior — Home Assistant unavailability, price data degradation, sensor anomalies, restart/staleness conditions, and DST transitions — to ensure the system fails safely rather than crashing or acting on bad data. These tests run hermetically as part of the standard pytest suite and gate every merge.
