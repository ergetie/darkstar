...
Resolve per-slot spot prices so that published Nordpool prices always take precedence over ML price forecasts, with forecasts used only for slots beyond the published horizon.
