# Spec: Multi-Day Deferral Controller

## Purpose

Defines the `MultiDayPlanner`, a load-type-agnostic component that distributes an energy requirement across multiple days based on price forecasts, with safeguards against over-deferral and respect for device power capacity.
