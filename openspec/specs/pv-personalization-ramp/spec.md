...
Ensure PV personalization starts safely from the Open-Meteo baseline and ramps bounded ML residuals only as sufficient home-specific data is collected.
