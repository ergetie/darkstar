...
## Purpose
Persist a per-run history of the S-Index debug record so past S-Index computations can be inspected and analyzed over time, independent of the learning subsystem's enable state, with bounded storage growth.
