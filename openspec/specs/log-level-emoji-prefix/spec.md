# Capability: Log Level Emoji Prefix

## Purpose

Add level-based emoji prefixes to human-facing log output so WARNINGS and ERRORs are visually distinguishable in the console and UI ring-buffer, while keeping machine-readable file logs unchanged.
