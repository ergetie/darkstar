...
def main():
    ...
    try:
        ...
        with sqlite3.connect(engine.db_path) as conn:
            ...
            print("-" * 60)
            print(
                f"{'Import (kWh)':<15} | {USER_IMPORT_NOV_24_30:<15.2f} | {ds_import:<15.2f} | {ds_import - USER_IMPORT_NOV_24_30:+.2f}"
            )
            print(
                f"{'Load (kWh)':<15} | {USER_LOAD_NOV_24_30:<15.2f} | {ds_load:<15.2f} | {ds_load - USER_LOAD_NOV_24_30:+.2f}"
            )
