        ...
        try:
            ...
            with sqlite3.connect(self.store.db_path) as conn:
                ...
                for p in plans_by_slot.values():
                    ...
                    """, (
                        slot_start_iso, p["planned_charge_kwh"], p["planned_discharge_kwh"],
                        p["planned_soc_percent"], p["planned_import_kwh"], p["planned_export_kwh"],
                        p["planned_cost_sek"]
                    ))
                    count += 1
        ...
        try:
            ...
            with sqlite3.connect(self.store.db_path) as conn:
                ...
                for row in rows:
                    ...
                    """, (
                        slot_start_iso, charge_kwh, discharge_kwh,
