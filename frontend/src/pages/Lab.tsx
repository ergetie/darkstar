    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      <header>
        ...
        <p className="text-muted mt-1">
          Run "What If?" simulations without affecting your real schedule.
        </p>
      </header>
        ...
        <div className="space-y-6">
          <div className="card p-5 space-y-6">
            ...
            <div className="pt-4 flex gap-3">
              ...
              >
                {loading ? 'Simulating...' : <><Play className="h-4 w-4" /> Run Sim</>}
              </button>
              <button
          ...
          <div className="card p-5 bg-surface/50 border-dashed">
            <p className="text-xs text-muted leading-relaxed">
              <strong>Note:</strong> These simulations use live market prices and forecasts. 
              Adjusting capacity scales your current SoC% to the new size. 
              Results are not saved to the planner.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          {simResult ? (
            <ChartCard
              range="48h"
              showDayToggle={false}
              slotsOverride={simResult.schedule}
            />
          ) : (
